...
public class DepartmentActivity extends AppCompatActivity implements OnMapReadyCallback, ActivityCompat.OnRequestPermissionsResultCallback{
//public class DepartmentActivity extends Activity{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        //
        setContentView(R.layout.departmentinfo);                            //이건 Activity에서 view 설정하는 법
        //LayoutInflater inflater = (LayoutInflater) getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        //View view = inflater.inflate(R.layout.departmentinfo, null) ;     //Fragment에서는 이렇게 view를 설정할 수 있음.

        this.position = getIntent().getExtras().getInt("position");
        this.dep_icon = getIntent().getExtras().getIntArray("dep_icon");
        this.dep_name = getIntent().getExtras().getStringArray("dep_name");
        departmentList = fragment3.departmentItemList;                   //activity에 ArrayList<Custom>을 어떻게 줘야하는질 몰라서 static 변수 사용.
        ...
        TextView tv_king_email = (TextView) findViewById(R.id.king_email);
        ...
        mLayout = findViewById(R.id.layout_dep);
        ...
        button1.setOnClickListener(new Button.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra("url",departmentList.get(position).getDep_url());
            ...
            if (ActivityCompat.shouldShowRequestPermissionRationale(this, REQUIRED_PERMISSIONS[0])) {
                ...
                Snackbar.make(mLayout, "이 앱을 실행하려면 위치 접근 권한이 필요합니다.",
                    ...
                    public void onClick(View view) {
                        ...
                        ActivityCompat.requestPermissions( (MainActivity) MainActivity.context_main ,  REQUIRED_PERMISSIONS,
    ...
    public void setCurrentLocation(Location location, String markerTitle, String markerSnippet) {
        ...
        LatLng now_building = new LatLng(departmentList.get(position).getDep_latitude(), departmentList.get(position).getDep_longitude());
        MarkerOptions markerOptions1 = new MarkerOptions();
        markerOptions1.position(now_building);
        markerOptions1.title(departmentList.get(position).getDep_name());
        markerOptions1.snippet( departmentList.get(position).getDep_num() );
        ...
        markerOptions.snippet("학과까지 거리 : " + Double.toString(distance) + "m");
